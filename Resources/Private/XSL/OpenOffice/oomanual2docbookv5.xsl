...
<!--			<xsl:attribute name="xmlns:xlink" namespace="http://www.w3.org/1999/xlink">http://www.w3.org/1999/xlink</xsl:attribute>
			<xsl:attribute name="xi">http://www.w3.org/2001/XInclude</xsl:attribute>
			<xsl:attribute name="svg">http://www.w3.org/2000/svg</xsl:attribute>
			<xsl:attribute name="m">http://www.w3.org/1998/Math/MathML</xsl:attribute>
			<xsl:attribute name="m">http://www.w3.org/1998/Math/MathML</xsl:attribute>
			<xsl:attribute name="html">http://www.w3.org/1999/xhtml</xsl:attribute>
			<xsl:attribute name="db">http://docbook.org/ns/docbook</xsl:attribute>-->
            <xsl:apply-templates/>
		</xsl:element>
	</xsl:template>
					...
					<xsl:element name="imageobject">
						<xsl:element name="imagedata">
							<xsl:attribute name="fileref">
								<xsl:choose>
									<xsl:when test="starts-with(@xlink:href, '#Pictures/')"><xsl:value-of select="substring(@xlink:href,11)"/></xsl:when>
								</xsl:choose>
							</xsl:attribute>
